  ...
  return (
    <div className='navbar'>
        ...
        <ul ref={menuRef} className='nav-menu'>
            ...
            <li onClick={()=>{setMenu("mens")}}><Link className="navbar-link" to='/mens'>Men</Link>{menu==="mens"?<hr/>:<></>}</li>
            <li onClick={()=>{setMenu("womens")}}><Link className="navbar-link" to='/womens'>Women</Link>{menu==="womens"?<hr/>:<></>}</li>
